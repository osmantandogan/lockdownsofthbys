...
barcode_stock_collection = db.barcode_stock  # Karekod bazlı stok (GTIN takip)
stock_locations_collection = db.stock_locations  # Stok lokasyonları
its_drugs_collection = db.its_drugs  # İTS ilaç veritabanı
